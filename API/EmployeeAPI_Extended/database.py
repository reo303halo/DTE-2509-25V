...
class DataBase():
    ...
    def getDeptByNo(self, deptno):
        self.cursor.execute("SELECT * FROM dept WHERE deptno = %s;", (deptno, ))
        return self.cursor.fetchone()
    
    def updateDept(self, deptno, dname, loc):
        self.cursor.execute("UPDATE dept SET dname = %s, loc = %s WHERE deptno = %s;",
                            (dname, loc, deptno))
    
    def deleteDept(self, deptno):
        self.cursor.execute("DELETE FROM dept WHERE deptno = %s;", (deptno,))
